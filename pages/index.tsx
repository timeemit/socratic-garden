...
const Index = () => {
  return (
        ...
        <img className={"pure-img centered " + styles.goth} src="/patrick/treehouse.png" />
				<h1 className="header centered-text">Thanks for Your Patience</h1>
        <img className={"pure-img centered " + styles.goth} src="/patrick/goth_stares_out_window-no_window.png" />
			</main>
		</Page>
  );
};
