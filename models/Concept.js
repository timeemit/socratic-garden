...
exports.CONCEPTS = [
    ...
    var text = _a.text, definition = _a.definition, aliases = _a.aliases;
    return { id: id, text: text, definition: definition, aliases: aliases, as: text };
});
function ConceptByText(text) {
    var concept = exports.CONCEPTS.find(function (concept) { return concept.text === text || concept.aliases.includes(text); });
    if (concept == null) {
...
function ConceptByID(id) {
    return exports.CONCEPTS.find(function (concept) { return concept.id === id; });
}
...
function ConceptsByText(text) {
    return exports.CONCEPTS.filter(function (concept) { return concept.text.toLowerCase().startsWith(text.toLowerCase()); });
}
